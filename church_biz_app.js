...
function showDetail(bizId) {
  ...
  var html='<div class="det-card">'+
    ...
    (b.web?'<div class="det-row"><span class="dl">홈페이지</span><a href="'+(b.web.startsWith('http')?b.web:'https://'+b.web)+'" target="_blank" style="font-size:12px;color:#185fa5;text-align:right;word-break:break-all">'+b.web+'</a></div>':'')+
