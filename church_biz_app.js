...
function showDetail(bizId) {
  ...
  var html='<div class="det-card">'+
    '<div style="display:flex;align-items:center;gap:13px;margin-bottom:13px">'+
      ...
      '<div style="font-size:12px;font-weight:600;color:var('+catColor(b.cat)+');margin-top:3px">'+b.cat+'</div>'+
    ...
    (b.web?'<div class="det-row"><span class="dl">홈페이지</span><a href="'+(b.web.startsWith('http')?b.web:'https://'+b.web)+'" target="_blank" style="font-size:12px;color:#185fa5;text-align:right;word-break:break-all;text-decoration:underline;cursor:pointer">'+b.web+' 🔗</a></div>':'')+
